...
function sair(){
  ...
  const nav=$('navOp'); if(nav) nav.classList.add('hidden');
  const pill=$('userPill'); if(pill) pill.textContent='Operador GSP';
  showToast('Dados dos chamados mantidos. Login do operador apagado.');
  go('view-login');
}
